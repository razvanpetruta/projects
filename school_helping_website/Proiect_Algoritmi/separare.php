...
<br>
<h1 class="text-center">Separarea cifrelor unui numar </h1>
...
<span style='color:#800080; '>{</span>
   <span style='color:#800000; font-weight:bold; '>int</span> numar<span style='color:#800080; '>;</span>
   ...
   <span style='color:#800080; '>{</span>
      ...
      <span style='color:#696969; '>//prelucrare cifra</span>
      <span style='color:#696969; '>//dupa ce am prelucrat cifra, o vom elimina din numar</span>
...
<span style='color:#800080; '>}</span> 
    ...
    <img class="img-fluid" src="media/separarecifre.jpg">
...
- citim numarul <br>
- cat timp numarul este diferit de 0 (mai avem cifre), in variabila ult_cifra vom memora ultima cifra a numarului si o vom prelucra, iar la final scapam de ultima cifra din numar
